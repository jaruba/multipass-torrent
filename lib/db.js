...
db.listenReplications = function(id) {
	server = net.createServer(function(c) { 
		...
		c.pipe(zlibDuplex(db.sync())).pipe(c); // TODO: is there a way to write this simpler?
...
function zlibDuplex(stream) {
	return stream;
	//return stream.pipe(zlib.createGzip()).pipe(zlib.createGunzip())
};
