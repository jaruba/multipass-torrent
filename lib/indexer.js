...
var TRACKERS = ["udp://open.demonii.com:1337/announce", "udp://tracker.openbittorrent.com:80/announce"]; // TODO: don't hardcode
var SEEDLEECH_TIMEOUT = 1000;
...
function seedleech(infoHash, callback)
{
	...
	setTimeout(cb, SEEDLEECH_TIMEOUT);
