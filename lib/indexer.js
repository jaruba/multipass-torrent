...
var MATCH_FILES = cfg.matchFiles || /.mp4$|.avi$|.mkv$/i; // video types we're interested in
var EXCLUDE = cfg.exclude || /^RARBG|^Sample$/i; // exclude from filename
//var MATCH_TRACKER = /demonii\.com|openbittorrent|leechers-paradise/; // trackers to get popularity from
var TRACKERS = cfg.trackers || ["udp://open.demonii.com:1337/announce", "udp://tracker.openbittorrent.com:80/announce"]; // TODO: don't hardcode
var TRACKER_TIMEOUT = cfg.trackerTimeout || 300;
